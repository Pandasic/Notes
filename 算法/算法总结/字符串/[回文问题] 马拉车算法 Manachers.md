---
title: [回文问题] 马拉车算法 Manachers
tag: [计算机课程学习,算法,算法总结,字符串,]
---
# 马拉车算法（Manacher's Algorithm）

[原文地址](https://www.jianshu.com/p/392172762e55)

[LeetCode 647 回文子串](https://leetcode-cn.com/problems/palindromic-substrings/solution/hui-wen-zi-chuan-by-leetcode-solution/)
...
![img](https://upload-images.jianshu.io/upload_images/5200803-aff5ee6f2bab5172?imageMogr2/auto-orient/strip|imageView2/2/w/1080/format/webp)

image


因为回文字符串是中心对称的，知道中心点位置id，如果一个位置的回文子串以i为中心，并且包含在以id为中心的回文子串中，即`mx > i`，那么肯定会存在另外一个以j为中心回文子串，和以i为中心的回文子串相等且对称，即`p[j] = p[i]`，而i和j是以id为中心对称，即`i+j=2*id`，如果知道了i的值，那么`j = 2*id - i`。
...
算法专题目前已连续**日更超过六个月**，算法题文章**211**+篇，公众号对话框回复【**数据结构与算法**】、【**算法**】、【**数据结构**】中的任一关键词，获取系列文章合集。
